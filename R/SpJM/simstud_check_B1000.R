...
save(mixedJM_no.miss_specluster_setup1,elapsed_no.miss_specluster_setup1,file="mixedJM_no_miss_specluster_setup1.RData")
...
save(mixedJM_no.miss_specluster_setup3,elapsed_no.miss_specluster_setup3,file="mixedJM_no_miss_specluster_setup3.RData")
...
res_eval(mixedJM_no.miss_specluster_setup1,hp)
